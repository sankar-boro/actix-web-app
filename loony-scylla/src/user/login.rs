...
use loony_service::{LoonyError, encrypt_text, encrypt_text_bytes};
...
fn create_user_token(user: &GetUser, session: &Session) -> Result<String, LoonyError> {
...
async fn try_login(request: &web::Form<LoginUserInfo>, app_data: &web::Data<App>, session: &Session) -> Result<HttpResponse, LoonyError> {
